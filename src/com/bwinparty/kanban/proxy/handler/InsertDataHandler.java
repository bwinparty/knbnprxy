 ...
 */
public class InsertDataHandler implements Handler<HttpServerRequest> {
    private static final Logger LOG = LoggerFactory.getLogger(InsertDataHandler.class);
        ...
        httpServerRequest.bodyHandler(new Handler<Buffer>() {
            ...
            public void handle(final Buffer buffer) {
                ...
                try {
                    ...
                    db.insert(buffer.toString(), collection);
                    output = "{\"status\":\"ok\"}";
                } catch (Exception ex) {
